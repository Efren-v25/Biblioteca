            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?= site_url('guardar'); ?>">
                        ...
                        <input type="checkbox" name="checkbox_inf" value="inf" 
                            onchange="this.form.submit()" 
                            <?php echo session("informatica") == 'inf' ? 'checked' : ''; ?>>
                        Ingenieria Informatica
                        <input type="checkbox" name="checkbox_mar" value="mar" 
                            onchange="this.form.submit()" 
                            <?php echo session("maritima") == 'mar' ? 'checked' : ''; ?>>
                        Ingenieria Maritima
                    <!-- Mostrar los errores -->
                    ...
                    <?php include("selectores.php"); ?>
                        ...
                        <br><button class="btn btn-primary" type="submit">Subir</button>
                    </form>
                </div>
            </div>
        </div>
